...
public:
     ...
     bool visitNode(TreeNode* p, TreeNode* &firstWrongNode,
                    TreeNode* &secondWrongNode, TreeNode* &prevNode)
     {
             cout << p->val << ",";
             if (prevNode && p->val < prevNode->val) {
                 if (!firstWrongNode) {
                     ...
                     int tmp = p->val;
                     p->val = firstWrongNode->val;
                     firstWrongNode->val = tmp;
                     secondWrongNode = p;
                     return true;
                 }
             }
     ...
     void recoverTree(TreeNode *root) {
         ...
         while (p) {
             if (!p->left) {
                 if (visitNode(p, firstWrongNode, secondWrongNode, prevNode)) {
                     recovered = true;
                 }
                 p = p->right;
                 continue;
